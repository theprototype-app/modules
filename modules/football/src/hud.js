			...
			screens: [
				{
					...
					elements: [
						...
						{ id: 'menu-hint', kind: 'text', anchor: 'center', x: 0, y: 176, w: 440, h: 30, z: 1, label: 'Walk into the ball to knock it  ·  Grab: hold click  ·  Pause: P', style: { size: 12, color: '#8b97a8', align: 'center' }, wrap: true }
					]
				},
				{
					id: 'hud',
